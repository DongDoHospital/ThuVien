...
function addProduct(p, ele, returnString) {
	...
	return addToWeb( product, ele, returnString , p.link);
}
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Thư viện điện tử" title="Thư viện điện tử">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Thư viện điện tử</a> - All rights reserved © 2024 - Designed by
            <span style="color: #eee; font-weight: bold">Phòng KHTH</span></p>
    </div>`);
}
